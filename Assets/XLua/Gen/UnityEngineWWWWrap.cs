...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineWWWWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.WWW), L, translator, 0, 5, 15, 1);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Dispose", _m_Dispose);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "InitWWW", _m_InitWWW);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.WWW), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.WWW), L, __CreateInstance, 4, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.WWW));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.WWW), L, translator);
        }

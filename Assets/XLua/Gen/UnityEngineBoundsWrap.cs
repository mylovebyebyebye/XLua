...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineBoundsWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.EndObjectRegister(typeof(UnityEngine.Bounds), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.Bounds), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.Bounds));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.Bounds), L, translator);
        }
